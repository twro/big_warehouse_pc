! function () {
    var citys = [{
        ...
        "n": "上海市",
        "c": [{
            "a": ["宝山区","南汇区","长宁区","卢湾区","杨浦区","闵行区","奉贤区","松江区","金山区","闸北区","青浦区","虹口区","徐汇区","浦东新区","崇明区","黄浦区","普陀区","嘉定区","静安区"],
            "n": "上海市"
        }, ]
    }, {
        "n": "天津市",
        ...
        "c": [{
            ...
            "a": ["滨城区", "邹平县", "沾化县", "惠民县", "博兴县", "阳信县", "无棣县"],
            "n": "滨州市"
        }, {
            "a": ["牡丹区", "单县", "曹县", "定陶县", "巨野县", "成武县", "东明县", "郓城县", "鄄城县"],
            "n": "菏泽市"
        }, {
            "a": ["岚山区", "市辖区", "五莲县", "东港区", "莒县"],
            "n": "日照市"
        }, {
            ...
            "a": ["长清区", "历城区", "天桥区", "槐荫区", "历下区", "市中区", "章丘市", "平阴县", "济阳县", "商河县"],
            "n": "济南市"
        }, {
        ...
        "n": "广东省",
        "c": [{
            "a": ["天河区", "海珠区", "荔湾区", "越秀区", "番禺区", "花都区", "萝岗区", "白云区", "南沙区", "黄埔区", "增城区", "从化区"],
            "n": "广州市"
        }, {
            "a": ["罗湖区", "福田区", "南山区", "宝安区", "光明新区", "龙岗区", "坪山区", "盐田区"],
            "n": "深圳市"
        }, {
            "a": ["斗门区", "金湾区", "香洲区"],
            "n": "珠海市"
            ...
            "a": ["惠阳区","惠城区", "惠东县", "博罗县", "龙门县"],
            "n": "惠州市"
        }, {
            "a": ["城区", "陆丰市", "陆河县", "海丰县"],
            "n": "汕尾市"
        }, {
            "a": ["长安镇", "莞城区", "南城区", "寮步镇", "大岭山镇", "横沥镇", "常平镇", "厚街镇", "万江区", "樟木头镇", "塘厦镇", "凤岗镇", "大朗镇", "东坑镇", "清溪镇", "企石镇", "茶山镇", "东城区", "虎门镇", "黄江镇", "石排镇", "道滘镇", "沙田镇", "高埗镇", "石龙镇", "石碣镇", "洪梅镇", "麻涌镇", "桥头镇", "望牛墩镇", "中堂镇", "谢岗镇"],
            "n": "东莞市"
        }, {
            "a": ["中山市市辖区","石岐区"],
            "n": "中山市"
            ...
            "a": ["连州市", "佛冈县", "阳山县", "清新县", "连山壮族瑶族自治县", "连南瑶族自治县", "清城区", "英德市"],
            "n": "清远市"
        }, {
            "a": ["湘桥区", "潮安区", "饶平县"],
            "n": "潮州市"
        }, {
            "a": ["普宁市", "榕城区", "揭东县", "揭西县", "惠来县"],
            "n": "揭阳市"
        }]
    }, {
        "n": "广西壮族自治区",
        ...
        "n": "贵州省",
        "c": [{
            "a": ["南明区", "云岩区", "花溪区", "小河区", "白云区", "清镇市", "修文县", "息烽县",  "观山湖区"],
            "n": "贵阳市"
        }, {
            "a": ["盘县", "六枝特区", "水城县", "钟山区",'盘州市'],
            "n": "六盘水市"
        }, {
            "a": ["红花岗区", "汇川区", "赤水市", "仁怀市", "遵义县", "桐梓县", "绥阳县", "习水县", "凤冈县", "正安县", "湄潭县", "余庆县", "道真县", "务川仡佬族苗族自治县"],
            "n": "遵义市"
        }, {
            "a": ["铜仁市", "德江县", "江口县", "思南县", "万山特区", "石阡县", "玉屏侗族自治县", "松桃苗族自治县", "印江土家族苗族自治县", "沿河土家族自治县","道真仡佬族苗族自治县","播州区"],
            "n": "铜仁地区"
        }, {
            "a": ["黔西县", "大方县", "织金县", "金沙县", "赫章县", "纳雍县", "威宁彝族回族苗族自治县","毕节市"],
            "n": "毕节地区"
        }, {
            "a": ["西秀区", "普定县", "平坝区", "镇宁布依族苗族自治县", "关岭布依族苗族自治县", "紫云苗族布依族自治县"],
            "n": "安顺市"
        }, {
            ...
            "a": ["都匀市", "福泉市", "贵定县", "惠水县", "罗甸县", "瓮安县", "荔波县", "龙里县", "平塘县", "长顺县", "独山县", "三都水族自治县"],
            "n": "黔南布依族苗族自治州"
        }]
    }, {
        "n": "云南省",
